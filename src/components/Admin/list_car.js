                ...
                {isVisible && <Modal footer={null} title="Edit" visible={true}  onCancel={()=>setIsvisible(false)}>
                                ...
                                >
                                    ...
                                    <Form.Item  {...tailLayout}>
                                        <button style={{ float:'right', backgroundColor:'orange', color:'white', width:'120px'}} type="submit" className="btn"> {loading?<Spin indicator={<LoadingOutlined style={{color: 'white'}}/>}/>:<span>Chỉnh sửa</span>}</button>
                                    </Form.Item>
                                </Form>
                            </Modal>}
